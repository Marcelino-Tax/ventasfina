        ...
        <div class="sidebar" data-color="purple" data-background-color="black" data-image="../assets/img/sidebar-1.jpg">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                         <a class="nav-link d-flex" href="https://drive.google.com/file/d/1lXb-imcRNY1XpciFnZzVbFqceH3Wi8Uv/view?usp=drive_link" target="_blank">
                         <i class="fas fa-question-circle mr-2 fa-2x"></i>
                         <p>Ayuda</p>
                        </a>
                    </li>
                </ul>
